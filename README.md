...
#### 1️⃣ Define your TypeScript contracts
...
#### 5️⃣ Use types from an external project
...
📖 **Complete documentation**: see [EXTERNAL_TYPES.md](./EXTERNAL_TYPES.md)
...
- Backend unreachable (proxy mode) → **502** Bad Gateway
...
│   │   ├── proxy.ts          # Fallback logic to real backend
